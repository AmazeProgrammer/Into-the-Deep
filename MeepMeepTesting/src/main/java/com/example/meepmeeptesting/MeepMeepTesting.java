...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(31.1875, -63.5, Math.toRadians(90)))
                ...
                .splineToSplineHeading(new Pose2d(48, -12, Math.toRadians(0)), Math.toRadians(270))
                ...
                .strafeToLinearHeading(new Vector2d(53.5, -63), Math.toRadians(90))
                /*
                .splineToSplineHeading(new Pose2d(40, -40, Math.toRadians(180)), Math.toRadians(150))
                .splineToConstantHeading(new Vector2d(3, -32.5), Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(53.5, -63, Math.toRadians(0)), Math.toRadians(300))

                .splineToSplineHeading(new Pose2d(40, -40, Math.toRadians(180)), Math.toRadians(150))
                .splineToConstantHeading(new Vector2d(6, -32.5), Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(6, -40, Math.toRadians(0)), Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(53.5, -63), Math.toRadians(0))

                .splineToSplineHeading(new Pose2d(40, -40, Math.toRadians(180)), Math.toRadians(150))
                .splineToConstantHeading(new Vector2d(-2, -32.5), Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(-2, -40, Math.toRadians(0)), Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(53.5, -63), Math.toRadians(0))

                .splineToSplineHeading(new Pose2d(40, -40, Math.toRadians(180)), Math.toRadians(150))
                .splineToConstantHeading(new Vector2d(-4, -32.5), Math.toRadians(180))
                .splineToSplineHeading(new Pose2d(-4, -40, Math.toRadians(0)), Math.toRadians(270))
                .splineToConstantHeading(new Vector2d(53.5, -63), Math.toRadians(0))
                */
                /*.strafeToLinearHeading(new Vector2d(6, -32.5), Math.toRadians(180))
                .strafeToLinearHeading(new Vector2d(53.5, -63), Math.toRadians(0))
