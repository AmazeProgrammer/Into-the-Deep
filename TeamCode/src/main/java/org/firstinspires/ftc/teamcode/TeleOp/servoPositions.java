...
public class servoPositions {
    ...
    public static double turnFrontServoUp = 0.3;
    ...
    public static double turnBackServoNormal = 0.37;
    public static int armSpecimenBack = 1685;
    public static int armSpecimenFront = 430;
    public static int armBucket = 1468;
